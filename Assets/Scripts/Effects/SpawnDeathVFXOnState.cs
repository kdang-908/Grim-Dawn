...
public class SpawnDeathVFXOnState : StateMachineBehaviour
{
    ...
    [Tooltip("Tên Transform ?? spawn VFX. ?? tr?ng = spawn t?i animator.transform")]
    ...
    [Tooltip("N?u prefab b? ng??c, ch?nh offset (vd: 0,180,0)")]
    public Vector3 rotationOffsetEuler = Vector3.zero;

    [Tooltip("L?y h??ng (Yaw) theo nhân v?t")]
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        float t = stateInfo.normalizedTime % 1f;   // l?y ph?n l? (?? phòng loop)
